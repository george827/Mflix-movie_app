            ...
            return (
              <div key={shows.id}>
                <div id={trailer ? "container" : "NoContainer"}>
                  ...
                  <img src={shows.poster_path ? `${img}${shows.poster_path}` : noImg} alt="" onClick={() => TvShowTitle(shows)} />
                  <h3 id={shows.name.lenght > 28 ? "smaller-Text" : ""} className={toggle ? "mainColor" : "secondaryColor"}>{shows.name}</h3>
                </div>
              </div>
            )
          })}
